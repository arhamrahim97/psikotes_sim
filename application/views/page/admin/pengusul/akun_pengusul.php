		...
		<div class="col-xl-12 col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">Akun Pengusul</h6>
					<div class="dropdown no-arrow">
					</div>

					<div class="modal fade" id="modalDetail" role="dialog" aria-labelledby="exampleModalLabel">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#tabel").DataTable({
			ajax: {
				url: '<?php echo base_url('getAkunPengusul') ?>',
				data: function(d) {},
				dataSrc: '',
				type: 'POST',
			},
	...
	$(document).ready(function() {
		$('#master-akunPengusul').addClass('active');
	})
</script>
