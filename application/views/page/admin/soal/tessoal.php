...
<body>
    <form action="hasilSoal" method="POST" id="isiSoal">
        <div class="container my-5">
            ...
            foreach ($subtes1 as $sub1) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes1[<?= $i ?>]" id="subtes1_<?= $i ?>" value="<?= $sub1->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub1->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes1[<?= $i ?>]" id="subtes1_<?= $i ?>" value="<?= $sub1->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub1->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes1[<?= $i ?>]" id="subtes1_<?= $i ?>" value="<?= $sub1->nilai_c ?>"></td>
                        <td width="2%">C.</td>
            ...
            foreach ($subtes2 as $sub2) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes2[<?= $i ?>]" id="subtes2_<?= $i ?>" value="<?= $sub2->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub2->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes2[<?= $i ?>]" id="subtes2_<?= $i ?>" value="<?= $sub2->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub2->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes2[<?= $i ?>]" id="subtes2_<?= $i ?>" value="<?= $sub2->nilai_c ?>"></td>
                        <td width="2%">C.</td>
            ...
            foreach ($subtes3 as $sub3) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes3[<?= $i ?>]" id="subtes3_<?= $i ?>" value="<?= $sub3->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub3->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes3[<?= $i ?>]" id="subtes3_<?= $i ?>" value="<?= $sub3->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub3->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes3[<?= $i ?>]" id="subtes3_<?= $i ?>" value="<?= $sub3->nilai_c ?>"></td>
                        <td width="2%">C.</td>
            ...
            foreach ($subtes4 as $sub4) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes4[<?= $i ?>]" id="subtes4_<?= $i ?>" value="<?= $sub4->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub4->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes4[<?= $i ?>]" id="subtes4_<?= $i ?>" value="<?= $sub4->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub4->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes4[<?= $i ?>]" id="subtes4_<?= $i ?>" value="<?= $sub4->nilai_c ?>"></td>
                        <td width="2%">C.</td>
                        <td><?= $sub4->pilihan_c ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes4[<?= $i ?>]" id="subtes4_<?= $i ?>" value="<?= $sub4->nilai_d ?>"></td>
                        <td width="2%">D.</td>
            ...
            foreach ($subtes5 as $sub5) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes5[<?= $i ?>]" id="subtes5_<?= $i ?>" value="<?= $sub5->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub5->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes5[<?= $i ?>]" id="subtes5_<?= $i ?>" value="<?= $sub5->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub5->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes5[<?= $i ?>]" id="subtes5_<?= $i ?>" value="<?= $sub5->nilai_c ?>"></td>
                        <td width="2%">C.</td>
                        <td><?= $sub5->pilihan_c ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes5[<?= $i ?>]" id="subtes5_<?= $i ?>" value="<?= $sub5->nilai_d ?>"></td>
                        <td width="2%">D.</td>
            ...
            foreach ($subtes6 as $sub6) { ?>
                ...
                <table class="table borderless ">
                    <tr>
                        <td width="2%"><input type="radio" name="subtes6[<?= $i ?>]" id="subtes6_<?= $i ?>" value="<?= $sub6->nilai_a ?>"></td>
                        <td width="2%">A.</td>
                        <td><?= $sub6->pilihan_a ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes6[<?= $i ?>]" id="subtes6_<?= $i ?>" value="<?= $sub6->nilai_b ?>"></td>
                        <td width="2%">B.</td>
                        <td><?= $sub6->pilihan_b ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes6[<?= $i ?>]" id="subtes6_<?= $i ?>" value="<?= $sub6->nilai_c ?>"></td>
                        <td width="2%">C.</td>
                        <td><?= $sub6->pilihan_c ?></td>
                    </tr>
                    <tr>
                        <td width="2%"><input type="radio" name="subtes6[<?= $i ?>]" id="subtes6_<?= $i ?>" value="<?= $sub6->nilai_d ?>"></td>
                        <td width="2%">D.</td>
            ...
            <button id="hitung" class="btn btn-primary" type="submit">Hitung</button>
        </div>
    </form>
            ...
            if (total_cek_subtes1 < subtes1) {
                ...
                if (hasil_akhir < kkm) {
                    Swal.fire({
                        icon: 'danger',
                        title: 'Anda GAGAL',
                        text: 'Anda Gagal Dengan Nilai Subtes 1 : ' + Math.round(hasil_subtes1) + '% | Subtes 2 : ' + Math.round(hasil_subtes2) + '% | Subtes 3 : ' + Math.round(hasil_subtes3) + '% | Subtes 4 : ' + Math.round(hasil_subtes4) + '% | Subtes 5 : ' + Math.round(hasil_subtes5) + '% | Subtes 6 : ' + Math.round(hasil_subtes6) + '% | Hasil Akhir : ' + Math.round(hasil_akhir) + '% | Standar Kelulusan : ' + kkm + "%",
                    })
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Anda LULUS',
                        text: 'Anda LULUS Dengan Nilai Subtes 1 : ' + Math.round(hasil_subtes1) + '% | Subtes 2 : ' + Math.round(hasil_subtes2) + '% | Subtes 3 : ' + Math.round(hasil_subtes3) + '% | Subtes 4 : ' + Math.round(hasil_subtes4) + '% | Subtes 5 : ' + Math.round(hasil_subtes5) + '% | Subtes 6 : ' + Math.round(hasil_subtes6) + '% | Hasil Akhir : ' + Math.round(hasil_akhir) + '% | Standar Kelulusan : ' + kkm + "%",
                    })
                }
            }
